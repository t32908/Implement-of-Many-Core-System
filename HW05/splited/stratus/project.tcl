...
define_hls_module Gaussian_Blur ../Gaussian_Blur.cpp

### 4. Define your HLS configuration (arbitrary names, BASIC and DPA in this example). 
define_hls_config Gaussian_Blur BASIC
define_hls_config Gaussian_Blur DPA       --dpopt_auto=op,expr
...
define_sim_config V_BASIC "Gaussian_Blur RTL_V BASIC" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
### 5.3 The Verilog simulation for HLS config "DPA". 
define_sim_config V_DPA "Gaussian_Blur RTL_V DPA" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
