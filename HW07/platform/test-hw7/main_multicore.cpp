...
public:
	...
	addr_t gaussianFilter_start_addr1 = 0x75000000;
	addr_t gaussianFilter_size1 = 0x01000000;
	addr_t gaussianFilter_end_addr1 = gaussianFilter_start_addr1 + gaussianFilter_size1 - 1;
	addr_t gaussianFilter_start_addr2 = 0x76000000;
	addr_t gaussianFilter_size2 = 0x01000000;
	addr_t gaussianFilter_end_addr2 = gaussianFilter_start_addr2 + gaussianFilter_size2 - 1;
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > gaussianFilter_end_addr1) &&
		       "RAM too big, would overlap memory");
		assert((mem_end_addr < clint_start_addr || mem_start_addr > gaussianFilter_end_addr2) &&
		       "RAM too big, would overlap memory");
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[14] = new PortMapping(opt.gaussianFilter_start_addr1, opt.gaussianFilter_end_addr1);
	bus.ports[15] = new PortMapping(opt.gaussianFilter_start_addr2, opt.gaussianFilter_end_addr2);
	...
	bus.isocks[14].bind(gaussian_filter1.tsock);
	bus.isocks[15].bind(gaussian_filter2.tsock);
