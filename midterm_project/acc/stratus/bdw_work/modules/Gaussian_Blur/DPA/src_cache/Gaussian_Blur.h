...
private:
  ...
  sc_dt::sc_int<9> blue;
  sc_dt::sc_int<25> total;
  sc_dt::sc_int<9> p_red;
  sc_dt::sc_int<9> p_green;
  sc_dt::sc_int<9> p_blue;
  sc_dt::sc_int<25> rgb_buffer[3][258];
  sc_dt::sc_int<9> filter[filterHeight][filterWidth];
};
#endif
