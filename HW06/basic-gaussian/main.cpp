...
// gaussian Filter ACC
static char* const gaussianFILTER_START_ADDR = reinterpret_cast<char* const>(0x75000000);
static char* const gaussianFILTER_READ_ADDR  = reinterpret_cast<char* const>(0x75000004);
