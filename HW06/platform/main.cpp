...
public:
	...
	addr_t gaussianFilter_start_addr = 0x75000000;
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[14] = new PortMapping(opt.gaussianFilter_start_addr, opt.gaussianFilter_end_addr);
	...
	bus.isocks[14].bind(gaussian_filter.tsock);
